...
public class UpdateStatusTest {
    ...
    // System.out.println("Result: " + (res09 &&
    // db.get(0).status.equals("CONFIRMED") ? "PASS" : "FAIL"));
    //
    ...
    // System.out.println("Result: " + (!res11 ? "PASS (System blocked invalid
    // change)" : "FAIL (Bug!)"));
    //
    // System.out.println("\n================ TEST COMPLETED ================");
    // }
    ...
    // System.out.println("Action: Changing Order #" + order.id + " from " +
