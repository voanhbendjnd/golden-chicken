    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            ...
            <head>
                ...
                <title>Create Create Page</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form:form method="post" action="/staff/category/create" modelAttribute="category">
                                        <div class="mb-3">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            <a href="/staff/category" class="btn btn-secondary me-md-2">Cancel</a>
