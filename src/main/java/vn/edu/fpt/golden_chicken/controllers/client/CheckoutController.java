...
public class CheckoutController {
    ...
    public String handleCheckout(
        ...
        CheckoutResponse response = checkoutService.buildCheckout(
                productId,
                ids,
                orderId,
                voucherId,
    ...
    public String applyVouchers(
        ...
        if (!selection.isValid()) {
            return handleCheckout(productId, ids, null, null, null, null, null, model);
        }
